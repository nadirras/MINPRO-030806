...
export class UserRouter {
  ...
  private initializeRoutes(): void {
    ...
    this.router.post(
      ...
      this.userMiddleware.verifyResetToken,
      this.userController.resetPassword,
    );
    this.router.post(
      '/request-change-role',
      this.userMiddleware.verifyToken,
      this.userController.requestRoleChange,
    );
    this.router.get(
      '/verify-role/:token',
      this.userMiddleware.verifyRole,
      this.userController.verifyChangeRole,
    );
    this.router.post(
      '/change-email',
      this.userMiddleware.verifyToken,
    ...
    this.router.get(
      '/verify',
      this.userMiddleware.verifyToken,
      this.userController.verifyAccount,
    );
    this.router.get(
      '/verify-email/:token',
      this.userMiddleware.verifyEmail,
      this.userController.verifyChangeEmail,
    );
    this.router.get(
      '/keep-login',
      this.userMiddleware.verifyToken,
